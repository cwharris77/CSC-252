...
countLetters:
	...
	#
	# 0 will be stored at a 0 offset from the sp and sp decreases by 4 while
	# i < 26
	#
	# registers:
	#	t0: i
...
subsCipher:
	...
	addiu $sp, $sp, -12			# save s registers
	sw   $s0, 0($sp)
	sw   $s1, 4($sp)
	sw   $s2, 8($sp)
